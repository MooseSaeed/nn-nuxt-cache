...
const mockedMeals = [
  ...
  },
  {
    ...
    excerpt:
      "Preheat the oven to 350°. Remove the stems from one bunch of Tuscan kale and tear the leaves into 1 pieces",
    instructions:
